	...
	*/
	function init(params) {
		...
		*/
		...
		var seleniumStartupParts =['java', '-jar', pathPrefix+'selenium/selenium-server-standalone-2.43.5.jar', '-p', '4444', '-Dwebdriver.chrome.driver='+pathPrefix+'selenium/chromedriver'];
		if(cfgJson.operatingSystem !==undefined && cfgJson.operatingSystem =='windows') {
			pathPrefix ='node_modules\\protractor\\';
			protractorPath ='node_modules\\.bin\\protractor';		//Windows
			seleniumStartupParts =['java', '-jar', pathPrefix+'selenium\\selenium-server-standalone-2.43.5.jar', '-p', '4444', '-Dwebdriver.chrome.driver='+pathPrefix+'selenium\\chromedriver.exe'];
		}
